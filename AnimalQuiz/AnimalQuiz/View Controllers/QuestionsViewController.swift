...
extension QuestionsViewController {
    ...
    private func nextQuestion() {
        ...
        guard let dest = storyboard?.instantiateViewController(identifier: "resultVC") as? ResultsViewController else { return }
        dest.resultAnswers = answerChosen
        dest.modalPresentationStyle = .fullScreen
        show(dest, sender: nil)
    }
}
